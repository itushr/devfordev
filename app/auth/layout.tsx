            ...
            <div className='flex w-full border rounded-2xl'>
                ...
                <div className='flex-1 px-5 sm:px-10 py-10 md:py-24 flex flex-col items-center justify-center'>
                    <div className='h-18 w-full flex items-center justify-between px-5 sm:justify-center sm:gap-10'>
                        <GoogleAuth className='w-16 h-16 rounded-full border cursor-pointer p-3'>
                        ...
                        <GitHubAuth className='w-16 h-16 rounded-full border cursor-pointer p-3'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                        ...
                        <DiscordAuth className='w-16 h-16 rounded-full border cursor-pointer p-3'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                        ...
                        <GuestAuth className='w-16 h-16 rounded-full border cursor-pointer p-3'>
